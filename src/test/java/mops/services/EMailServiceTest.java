...
class EMailServiceTest {
    ...
    void checkMethodCallToRecipient() {
        ...
        eMailService.sendEmailToRecipient("createNewApplicantIfNoneWasFound@example.com", new File(file));
    ...
    void checkMethodCallToD3() {
        ...
        String[] array = {"createNewApplicantIfNoneWasFound@example.com", "test2@example.com"};
