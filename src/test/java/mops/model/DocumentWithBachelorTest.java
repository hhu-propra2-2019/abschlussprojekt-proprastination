...
class DocumentWithBachelorTest {
    ...
    void save() throws IOException {
        ...
        document.save(new File( File.separator + "tmp" + File.separator + "createNewApplicantIfNoneWasFound.pdf"));

        PDDocument document1 = PDDocument.load(new File( File.separator + "tmp" + File.separator + "createNewApplicantIfNoneWasFound.pdf"));
