...
class DocumentWithBachelorTest {
    ...
    void save() throws IOException {
        ...
        document.save(new File( System.getProperty("user.dir") + "tmp" + File.separator + "createNewApplicantIfNoneWasFound.pdf"));

        PDDocument document1 = PDDocument.load(new File( System.getProperty("user.dir") + "tmp" + File.separator + "createNewApplicantIfNoneWasFound.pdf"));
